...
export interface DocumentFolder {
    name:   string;
    Folder: PurpleFolder[] | AmbitiousFolder;
}
...
export interface FluffyFolder {
    name:   string;
    Folder: TentacledFolder[] | HilariousFolder;
}

export interface TentacledFolder {
    name:       string;
    Folder?:    StickyFolder[] | IndecentFolder;
    Placemark?: PurplePlacemark[] | PurplePlacemark;
}

export interface StickyFolder {
    name:       string;
    Folder?:    IndigoFolder[] | IndigoFolder;
    Placemark?: PurplePlacemark[] | PurplePlacemark;
}
...
export interface AmbitiousFolder {
    name:   string;
    Folder: CunningFolder[];
}

export interface CunningFolder {
    name:   string;
    Folder: MagentaFolder[];
}

export interface MagentaFolder {
    name:   string;
    Folder: FriskyFolder[];
}

export interface FriskyFolder {
    name:       string;
    Folder?:    MischievousFolder[] | Folder7;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
}

export interface MischievousFolder {
    name:       string;
    Folder?:    BraggadociousFolder[] | Folder4;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
}

export interface BraggadociousFolder {
    name:       string;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
    Folder?:    Folder1[] | Folder3;
}
...
export interface FolderPlacemarkClass {
    name:       string;
    styleUrl:   string;
    Region?:    Region;
...
export interface Folder4 {
    name:       string;
    Folder?:    Folder1[] | Folder5;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
}

export interface Folder5 {
    name:       string;
    Folder?:    Folder6[] | Folder6;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
}

export interface Folder6 {
    name:      string;
    Placemark: FolderPlacemarkClass;
}

export interface Folder7 {
    name:       string;
    Placemark?: FolderPlacemarkClass[] | FolderPlacemarkClass;
...
const typeMap: any = {
    ...
    "DocumentFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(a(r("PurpleFolder")), r("AmbitiousFolder")) },
    ], false),
    "PurpleFolder": o([
        { json: "name", js: "name", typ: "" },
    ...
    "FluffyFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(a(r("TentacledFolder")), r("HilariousFolder")) },
    ], false),
    "TentacledFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("StickyFolder")), r("IndecentFolder"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("PurplePlacemark")), r("PurplePlacemark"))) },
    ], false),
    "StickyFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("IndigoFolder")), r("IndigoFolder"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("PurplePlacemark")), r("PurplePlacemark"))) },
    ], false),
    "IndigoFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(a(r("PurplePlacemark")), r("PurplePlacemark")) },
    ], false),
    "PurplePlacemark": o([
        { json: "@id", js: "@id", typ: "" },
        { json: "name", js: "name", typ: "" },
    ...
    "HilariousFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: r("IndigoFolder") },
    ], false),
    "AmbitiousFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: a(r("CunningFolder")) },
    ], false),
    "CunningFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: a(r("MagentaFolder")) },
    ], false),
    "MagentaFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: a(r("FriskyFolder")) },
    ], false),
    "FriskyFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("MischievousFolder")), r("Folder7"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
    ], false),
    "MischievousFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("BraggadociousFolder")), r("Folder4"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
    ], false),
    "BraggadociousFolder": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("Folder1")), r("Folder3"))) },
    ], false),
    "Folder1": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("Folder2")), r("Folder2"))) },
    ], false),
    "Folder2": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass")) },
    ], false),
    "FolderPlacemarkClass": o([
        { json: "name", js: "name", typ: "" },
        { json: "styleUrl", js: "styleUrl", typ: "" },
        { json: "Region", js: "Region", typ: u(undefined, r("Region")) },
    ...
    "Folder3": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass")) },
        { json: "Folder", js: "Folder", typ: u(undefined, a(r("Folder2"))) },
    ], false),
    "Folder4": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("Folder1")), r("Folder5"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
    ], false),
    "Folder5": o([
        { json: "name", js: "name", typ: "" },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("Folder6")), r("Folder6"))) },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
    ], false),
    "Folder6": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: r("FolderPlacemarkClass") },
    ], false),
    "Folder7": o([
        { json: "name", js: "name", typ: "" },
        { json: "Placemark", js: "Placemark", typ: u(undefined, u(a(r("FolderPlacemarkClass")), r("FolderPlacemarkClass"))) },
        { json: "Folder", js: "Folder", typ: u(undefined, u(a(r("Folder6")), r("Folder2"))) },
    ], false),
    "Style": o([
        { json: "@id", js: "@id", typ: "" },
